...
#include <SITL/SITL.h>
  ...
  #define RELAY1_PIN_DEFAULT HAL_GPIO_PIN_POS_LIGHTS
  #define RELAY2_PIN_DEFAULT HAL_GPIO_PIN_BCN_LIGHTS
  #define RELAY3_PIN_DEFAULT HAL_GPIO_PIN_CHUTE_RELEASE
  #define RELAY4_PIN_DEFAULT HAL_GPIO_PIN_BLN_RELEASE
  #define RELAY5_PIN_DEFAULT HAL_GPIO_PIN_HSTM_POWER
#endif
