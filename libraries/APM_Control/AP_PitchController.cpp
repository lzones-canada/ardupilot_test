...
const AP_Param::GroupInfo AP_PitchController::var_info[] = {
    ...
    // @Increment: 0.5
    // @User: Advanced
    AP_GROUPINFO("_NGLIM", 12, AP_PitchController, _ng_limit, 2.0f),
    ...
    // @Increment: 0.05
    // @User: Advanced
    AP_GROUPINFO("_MGTC", 13, AP_PitchController, _manoeuvre_tconst, 0.5f),
    ...
    // @Increment: 0.5
    // @User: Advanced
    AP_GROUPINFO("_VSTALL", 14, AP_PitchController, _stall_speed, 0.0f),
...
float AP_PitchController::_limit_desired_rate(float desired_rate, float scaler, float aspeed)
{
    ...
    const float air_density_ratio = ahrs.get_air_density_ratio();
